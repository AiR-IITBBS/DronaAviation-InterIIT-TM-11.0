...
def hover(flight_duration = 25 , id=0 ):
    ...
    k_values =  [[300 , 200, 200], 
                 [ 0.000001,  0.000001, 0.000001], 
                 [ 6000,  7000 , 7000]]# PID, TPR

                #  [[300 , 200, 200], 
                #  [ 0.000001,  0.000001, 0.000001], 
                #  [ 6000,  7000 , 7000]]

    range = [[1450, 1700], [1400, 1600], [1400, 1600]] # TPR
    ...
    pos_tracker = PositionTracker(aruco_dict_type, k, d, camera_src=2, wait_time=1, smoothing_factor=5)
    pos_tracker.start()
